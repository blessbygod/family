        ...
        this.renderList = function($listUL, list, isTo){
            ...
            var _listTemplate = [
                '<% _.each(list,function(item){ %>',
                    ...
                    isTo? '<span title="<%= item[itemText] %>" class="word_break8"><%= context.highLightSearchKeyWord(item[itemText], context.dealWithKeyWord(isTo)) %></span>'
                       :
                       '<span title="<%= item[itemText] %>" class="word_break7"><%= context.highLightSearchKeyWord(item[itemText], context.dealWithKeyWord(isTo)) %></span>',
